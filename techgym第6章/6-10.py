...
def win():
   if Human.cards[0].number + Human.cards[1].number == 21:
      print("勝ち")
...
def show_cards(playerCards):
  plt.subplot(1,6,1)
  plt.axis("off")
  plt.imshow(playerCards[0].image)
  print(f"{Human.cards[0].mark}{Human.cards[0].display_name}")
  plt.subplot(1,6,2)
  plt.axis("off")
  plt.imshow(playerCards[1].image)
  print(f"{Human.cards[1].mark}{Human.cards[1].display_name}")
  plt.show()
