...
class Player:
    ...
    def set_bet_coin(self, bet_coin,bet_cell):
        ...
        self.bets[bet_cell] = int(bet_coin)
...
class Human(Player):
    ...
    def get_double_up(self):
        double_up = input("ダブルアップしますか？：(Y or N)")
        while double_up not in ['Y', 'N']:
            double_up = input("ダブルアップしますか？：(Y or N)")
