...
def get_play_score(myself,enemy):
  b_score=int(Team.get_hit_rate(myself)) - int(Team.get_out_rate(enemy))
...
def play():
  ...
  enemy=choice_team (2)
  get_play_score(myself,enemy)
  print('デバッグログ：'+str(get_play_score(myself,enemy)))
